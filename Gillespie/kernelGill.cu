...
void simulate(int numberOfExecutions, float* output, curandState *state, float step, float endTime, float segmentSize, float* Mdm2_aux, float* Mdm2_global, float* p53_aux, float* p53_global, float* Mdm2_p53_aux, float* Mdm2_p53_global, float* Mdm2_mRNA_aux, float* Mdm2_mRNA_global, float* p53_mRNA_aux, float* p53_mRNA_global, float* ATMA_aux, float* ATMA_global, float* ATMI_aux, float* ATMI_global, float* p53_P_aux, float* p53_P_global, float* Mdm2_P_aux, float* Mdm2_P_global, float* IR_aux, float* IR_global, float* ROS_aux, float* ROS_global, float* damDNA_aux, float* damDNA_global, float* E1_aux, float* E1_global, float* E2_aux, float* E2_global, float* E1_Ub_aux, float* E1_Ub_global, float* E2_Ub_aux, float* E2_Ub_global, float* Proteasome_aux, float* Proteasome_global, float* Ub_aux, float* Ub_global, float* p53DUB_aux, float* p53DUB_global, float* Mdm2DUB_aux, float* Mdm2DUB_global, float* DUB_aux, float* DUB_global, float* Mdm2_p53_Ub_aux, float* Mdm2_p53_Ub_global, float* Mdm2_p53_Ub2_aux, float* Mdm2_p53_Ub2_global, float* Mdm2_p53_Ub3_aux, float* Mdm2_p53_Ub3_global, float* Mdm2_p53_Ub4_aux, float* Mdm2_p53_Ub4_global, float* Mdm2_P1_p53_Ub4_aux, float* Mdm2_P1_p53_Ub4_global, float* Mdm2_Ub_aux, float* Mdm2_Ub_global, float* Mdm2_Ub2_aux, float* Mdm2_Ub2_global, float* Mdm2_Ub3_aux, float* Mdm2_Ub3_global, float* Mdm2_Ub4_aux, float* Mdm2_Ub4_global, float* Mdm2_P_Ub_aux, float* Mdm2_P_Ub_global, float* Mdm2_P_Ub2_aux, float* Mdm2_P_Ub2_global, float* Mdm2_P_Ub3_aux, float* Mdm2_P_Ub3_global, float* Mdm2_P_Ub4_aux, float* Mdm2_P_Ub4_global, float* p53_Ub4_Proteasome_aux, float* p53_Ub4_Proteasome_global, float* Mdm2_Ub4_Proteasome_aux, float* Mdm2_Ub4_Proteasome_global, float* Mdm2_P_Ub4_Proteasome_aux, float* Mdm2_P_Ub4_Proteasome_global, float* GSK3b_aux, float* GSK3b_global, float* GSK3b_p53_aux, float* GSK3b_p53_global, float* GSK3b_p53_P_aux, float* GSK3b_p53_P_global, float* Abeta_aux, float* Abeta_global, float* AggAbeta_Proteasome_aux, float* AggAbeta_Proteasome_global, float* AbetaPlaque_aux, float* AbetaPlaque_global, float* Tau_aux, float* Tau_global, float* Tau_P1_aux, float* Tau_P1_global, float* Tau_P2_aux, float* Tau_P2_global, float* MT_Tau_aux, float* MT_Tau_global, float* AggTau_aux, float* AggTau_global, float* AggTau_Proteasome_aux, float* AggTau_Proteasome_global, float* Proteasome_Tau_aux, float* Proteasome_Tau_global, float* PP1_aux, float* PP1_global, float* NFT_aux, float* NFT_global, float* ATP_aux, float* ATP_global, float* ADP_aux, float* ADP_global, float* AMP_aux, float* AMP_global, float* AbetaDimer_aux, float* AbetaDimer_global, float* AbetaPlaque_GliaA_aux, float* AbetaPlaque_GliaA_global, float* GliaI_aux, float* GliaI_global, float* GliaM1_aux, float* GliaM1_global, float* GliaM2_aux, float* GliaM2_global, float* GliaA_aux, float* GliaA_global, float* antiAb_aux, float* antiAb_global, float* Abeta_antiAb_aux, float* Abeta_antiAb_global, float* AbetaDimer_antiAb_aux, float* AbetaDimer_antiAb_global, float* degAbetaGlia_aux, float* degAbetaGlia_global, float* disaggPlaque1_aux, float* disaggPlaque1_global, float* disaggPlaque2_aux, float* disaggPlaque2_global, float* Source_aux, float* Source_global, float* Sink_aux, float* Sink_global) {
	...
	while (time < endTime && time < (numberOfExecutions + 1)*segmentSize) {
		...
		if (time >= segmentSize * numberOfExecutions + step * stepCount) {
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 0], Mdm2);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 1], p53);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 2], Mdm2_p53);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 3], Mdm2_mRNA);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 4], p53_mRNA);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 5], ATMA);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 6], ATMI);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 7], p53_P);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 8], Mdm2_P);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 9], IR);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 10], ROS);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 11], damDNA);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 12], E1);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 13], E2);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 14], E1_Ub);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 15], E2_Ub);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 16], Proteasome);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 17], Ub);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 18], p53DUB);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 19], Mdm2DUB);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 20], DUB);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 21], Mdm2_p53_Ub);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 22], Mdm2_p53_Ub2);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 23], Mdm2_p53_Ub3);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 24], Mdm2_p53_Ub4);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 25], Mdm2_P1_p53_Ub4);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 26], Mdm2_Ub);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 27], Mdm2_Ub2);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 28], Mdm2_Ub3);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 29], Mdm2_Ub4);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 30], Mdm2_P_Ub);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 31], Mdm2_P_Ub2);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 32], Mdm2_P_Ub3);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 33], Mdm2_P_Ub4);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 34], p53_Ub4_Proteasome);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 35], Mdm2_Ub4_Proteasome);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 36], Mdm2_P_Ub4_Proteasome);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 37], GSK3b);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 38], GSK3b_p53);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 39], GSK3b_p53_P);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 40], Abeta);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 41], AggAbeta_Proteasome);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 42], AbetaPlaque);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 43], Tau);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 44], Tau_P1);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 45], Tau_P2);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 46], MT_Tau);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 47], AggTau);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 48], AggTau_Proteasome);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 49], Proteasome_Tau);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 50], PP1);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 51], NFT);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 52], ATP);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 53], ADP);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 54], AMP);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 55], AbetaDimer);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 56], AbetaPlaque_GliaA);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 57], GliaI);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 58], GliaM1);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 59], GliaM2);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 60], GliaA);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 61], antiAb);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 62], Abeta_antiAb);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 63], AbetaDimer_antiAb);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 64], degAbetaGlia);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 65], disaggPlaque1);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 66], disaggPlaque2);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 67], Source);
			atomicAdd(&output[69 * 17 * numberOfExecutions + stepCount * 69 + 68], Sink);
			stepCount++;
		}
		sum_p = 0;
		for (int i = 0; i < 112; i++) {
...
int main()
{
	...
	float* output;
	float* dev_output;
	output = (float*)malloc(67 * 69 * sizeof(float));
	for (int i = 0; i < 67 * 69; i++) {
		output[i] = 0;
	}
	cudaStatus = cudaMalloc(&dev_output, 67 * 69 * sizeof(float));
	if (cudaStatus != cudaSuccess) { fprintf(stderr, "cudaMalloc failed!"); goto Error; }
	cudaStatus = cudaMemcpy(dev_output, output, 67 * 69 * sizeof(float), cudaMemcpyHostToDevice);
	...
	cudaStatus = cudaMemcpy(output, dev_output, 67 * 69 * sizeof(float), cudaMemcpyDeviceToHost);
	if (cudaStatus != cudaSuccess) { fprintf(stderr, "cudaMemcpy failed!"); goto Error; }
